...
public class ProfileServiceImpl implements ProfileService {
    ...
    @Autowired
    public ProfileServiceImpl(Utilities utilities) {
    ...
    public Long createProfile(String email) throws JobPortalException {
        ...
        profile.setId(utilities.getNextSequence("profiles")); // Correct way to call the method
        ...
        return profile.getId(); // Ensure a return statement is present    
    }
